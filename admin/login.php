...
<form class="login" action="javascript:login();">
	<h1>Bhubejhr API</h1>
	<p>Version 1.0.0</p>
	<input class="inputtext" type="text" id="username" placeholder="อีเมล" autofocus>
	<input class="inputtext" type="password" id="password" placeholder="รหัสผ่าน">
