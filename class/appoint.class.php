...
class Appoint{
    ...
    public function get($hn){
        $this->db->query('SELECT date(va.dateappoint) as appointdate
...
INNER JOIN c_clinic c ON c.clinic = va.clinic
INNER JOIN c_section s ON s.sectioncode = va.sectioncode
